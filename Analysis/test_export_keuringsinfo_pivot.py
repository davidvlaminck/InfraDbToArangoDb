...
def test_pivot_result_key_cutoff_and_blank_handling():
    ...
    assert _pivot_result_key(r1, cutoff=cutoff) is None  # not > cutoff
    ...
    assert _pivot_result_key(r2, cutoff=cutoff) is None  # blank
...
def test_build_pivot_excludes_not_meegenomen_by_default():
    cutoff = dt.date(2021, 1, 1)
